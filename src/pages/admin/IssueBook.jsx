  ...
  const handleBarcodeSubmit = async (e) => {
    ...
    try {
      ...
      if (!found) {
        ...
        setError(`"${found.title}" is already issued.`);
        setBarcode(""); barcodeRef.current?.focus();
  ...
  return (
    <AdminLayout>
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm mt-1">Enter student PIN, then scan the book barcode.</p>
      </div>
      ...
      <div className="max-w-lg">
        ...
        {step === STEPS.BARCODE && student && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <p className="text-sm text-gray-400 mb-5">Click the field and scan with your scanner.</p>
            ...
            <div className="bg-gray-50 rounded-xl p-5 mb-6 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{book.author} · {book.barcode}</p>
                </div>
              </div>
            </div>
            <div className="flex gap-3">
